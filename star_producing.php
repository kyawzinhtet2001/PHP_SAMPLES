...
function get_all_star(int $total = 5)
{
    for ($i = 0; $i < $total; $i++) {
        for ($j = 0; $j < $total; $j++) {
            echo "*";
...
function get_all_star_one_side(int $total = 5)
{
    for ($i = 0; $i < $total; $i++) {
        for ($j = 0; $j < $total; $j++) {
            if ($j < $i + 1)
...
function get_all_star_one_reverse_side(int $total = 5)
{
    for ($i = 0; $i < $total; $i++) {
        for ($j = 0; $j < $total - $i; $j++) {
            echo "*";
...
get_all_star();
echo "\n";
get_all_star_one_side();
echo "\n";
get_all_star_one_reverse_side();
echo "\n";
get_diamondshape();
